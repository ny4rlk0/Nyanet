...
> [!WARNING]
> Remove Kaspersky completely and add folder exclusion to ESET Antivirus for using this. Else software might not work as intended. Other AV's should be fine without doing anything.
